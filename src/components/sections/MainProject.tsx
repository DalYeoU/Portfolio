...
const TEAM_PROJECTS = [
  ...
  },
  {
    ...
    issues: [
      {
        system: {
          label: "인벤토리 · 몬스터 감지 · 전투 밸런스.",
          desc: "아이템/인벤토리 시스템을 구축하고, 플레이어와의 거리 기반 몬스터 상태(대기/추적/전투) 전환 로직을 구현했습니다. 전투에서는 방어력 감쇠 공식과 DEX 기반 명중률 공식을 직접 설계하고, 대쉬 게이지·회피 판정을 포함한 전투 시스템을 구현했습니다.",
        },
        problem:
